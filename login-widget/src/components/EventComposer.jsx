...
export default function EventComposer({
  ...
  if (published) {
    ...
    return (
      <div className="lb-card">
        ...
        <p style={{ color: 'var(--muted,#6b5a3e)', marginBottom: '1rem' }}>
        ...
        <div className="lb-inset" style={{ marginBottom: '1rem' }}>
          <div style={{ fontSize: '0.72rem', color: 'var(--muted,#6b5a3e)', textTransform: 'uppercase', letterSpacing: '0.04em', marginBottom: '0.3rem' }}>
            Event address (naddr)
          </div>
          <code style={{ fontSize: '0.78rem', color: 'var(--text,#2d2010)', wordBreak: 'break-all', fontFamily: 'ui-monospace, SFMono-Regular, Menlo, monospace' }}>
            {published.naddr}
          </code>
        </div>
  ...
  return (
    <div className="lb-card relative space-y-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <div>
          <label className="lb-label">
            End date <span style={{ color: 'var(--muted,#6b5a3e)', textTransform: 'none', letterSpacing: 0, fontWeight: 400 }}>(optional)</span>
          </label>
          <input
            type="date"
            value={form.endDate}
        ...
        {!form.allDay && (
          <div>
            <label className="lb-label">
              End time <span style={{ color: 'var(--muted,#6b5a3e)', textTransform: 'none', letterSpacing: 0, fontWeight: 400 }}>(optional)</span>
            </label>
            <input
              type="time"
              value={form.endTime}
      ...
      <div>
        <label className="lb-label">
          Image <span style={{ color: 'var(--muted,#6b5a3e)', textTransform: 'none', letterSpacing: 0, fontWeight: 400 }}>(optional)</span>
        </label>
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              style={{ color: 'var(--orange,#f7931a)', fontSize: '0.85rem', fontWeight: 600, background: 'none', border: 'none', cursor: imageUploading ? 'not-allowed' : 'pointer', opacity: imageUploading ? 0.5 : 1, padding: 0 }}
            >
          ...
          {form.image && isSafeUrl(form.image) && (
            <img src={form.image} alt="" style={{ maxHeight: '10rem', borderRadius: '6px', border: '1px solid var(--border,#d4c4a0)' }} />
          )}
        </div>
      </div>
      ...
      <div>
        <label className="lb-label">
          Hashtags <span style={{ color: 'var(--muted,#6b5a3e)', textTransform: 'none', letterSpacing: 0, fontWeight: 400 }}>(space or comma separated)</span>
        </label>
        <input
          type="search"
          value={form.hashtags}
      ...
      <div style={{ borderTop: '1px solid var(--border,#d4c4a0)', paddingTop: '1.1rem' }} className="space-y-3">
