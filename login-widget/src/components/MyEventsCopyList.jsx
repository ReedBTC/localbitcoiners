...
export default function MyEventsCopyList({ pubkey, enabled, onCopy, manageUrl }) {
  ...
  if (!pubkey) {
    return (
      <div style={{ borderTop: '1px solid var(--border,#d4c4a0)', paddingTop: '0.7rem', marginTop: '0.2rem' }}>
        <p style={{ color: 'var(--muted,#6b5a3e)', fontSize: '0.82rem', fontStyle: 'italic', margin: 0 }}>
    ...
    <div style={{ borderTop: '1px solid var(--border,#d4c4a0)', paddingTop: '0.7rem', marginTop: '0.2rem' }}>
      <div style={{
        ...
        <span style={{
          ...
          color: 'var(--muted,#6b5a3e)', fontWeight: 600,
        }}>
        ...
        {manageUrl && (
          <a
            ...
            style={{ color: 'var(--orange,#f7931a)', fontSize: '0.78rem', fontWeight: 600, textDecoration: 'none', whiteSpace: 'nowrap' }}
