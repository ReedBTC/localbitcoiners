...
export default function SearchMeetupsModal({ onClose, onBoostMeetup, embedded = false }) {
  ...
  const body = (
    <>
        ...
        {phase === 'idle' && (
          <p style={{ color: 'var(--muted,#6b5a3e)', fontSize: '0.85rem', marginTop: '0.85rem' }}>
        ...
        {phase === 'authors' && authors.length > 0 && (
          <div style={{ marginTop: '0.85rem' }}>
            <div style={{
              ...
              color: 'var(--muted,#6b5a3e)', fontWeight: 600, marginBottom: '0.5rem',
            }}>
              Pick an account
            </div>
            {authors.map(a => (
              ...
              >
                {a.picture
                  ...
                  : <div className="lb-author-pick" style={{ padding: 0, width: 32, height: 32, borderRadius: '50%', border: '1px solid var(--border,#d4c4a0)', background: 'var(--cream-d,#ede3c8)' }} />}
          ...
          <div style={{ marginTop: '0.85rem' }}>
            {selectedAuthor && authors.length > 0 && (
              <button
                ...
                style={{
                  background: 'none', border: 'none', color: 'var(--navy,#3a3125)',
