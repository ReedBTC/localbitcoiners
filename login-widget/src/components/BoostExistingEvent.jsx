  ...
  return (
    <div className="lb-card relative space-y-3">
      ...
      <div>
        ...
        />
        <p style={{ fontSize: '0.78rem', color: 'var(--muted,#6b5a3e)', marginTop: '0.35rem' }}>
      ...
      <div>
        <label className="lb-label">
          Boost message <span style={{ color: 'var(--muted,#6b5a3e)', textTransform: 'none', letterSpacing: 0, fontWeight: 400 }}>(editable)</span>
        </label>
        <textarea
          value={message}
