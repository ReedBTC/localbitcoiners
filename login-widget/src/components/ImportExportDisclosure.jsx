  ...
  return (
    ...
    >
      ...
      <div style={{ padding: '0.4rem 0.85rem 0.85rem' }} className="space-y-2">
        <p style={{ fontSize: '0.78rem', lineHeight: 1.45, color: 'var(--muted,#6b5a3e)', margin: 0 }}>
          {description}
        </p>
              ...
              {exportOpen && (
                <>
                  ...
                  <div style={{
                    ...
                    border: '1px solid var(--border,#d4c4a0)', background: 'var(--white,#fffdf7)',
                    ...
                    {exportMenuItems.map((item, i) => (
                      <button
                        ...
                        style={{
                          ...
                          color: item.disabled ? 'var(--muted,#6b5a3e)' : 'var(--text,#2d2010)',
                          background: 'transparent', border: 'none',
                          cursor: item.disabled ? 'not-allowed' : 'pointer',
                        }}
                        onMouseEnter={e => { if (!item.disabled) e.currentTarget.style.background = 'var(--cream,#f5eedc)' }}
