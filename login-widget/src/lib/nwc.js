 ...
 * through the same `executeNip47Request` every SDK method uses (private in
 * the typings, public at runtime on @getalby/sdk 7.0.0), with a validator
 * that accepts any transaction object.
 *
