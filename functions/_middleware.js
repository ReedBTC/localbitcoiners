...
<header id="top-nav">
  <div class="nav-inner">
        ...
        <div class="nav-explore-panel">
          ...
          <div class="nav-explore-groups">
            <div class="nav-explore-group">
              ...
              <a href="/#market"><span aria-hidden="true">👕</span> Merch</a>
            </div>
            <div class="nav-explore-group">
              <h4>Community</h4>
              <a href="/#events"><span aria-hidden="true">🗞️</span> Feeds</a>
    ...
    <!-- Cart icon → merch checkout cart. Hidden by nav.js until the cart
         ...
         window.openMerchCart) or navigates to /#market-cart. -->
    <a id="nav-cart-link" class="nav-cart" href="/#market-cart" aria-label="View cart" style="display:none">
